...
function check_var_alignment_with_constraints(current_model, constr, NG, NT, dec_symbol)
    ...
    _, sort_order_1, is_included_in_current_constr_1 =
        get_index_in_constraint(target_var, current_model, constr, NG, NT, g, t, -2)
    ...
    _, sort_order_2, is_included_in_current_constr_2 =
        get_index_in_constraint(target_var, current_model, constr, NG, NT, g, t, -2)
