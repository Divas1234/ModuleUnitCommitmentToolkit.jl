...
frequency_data <- read.csv("d:/GithubClonefiles/RFCUC/RfcucCaseStudies/eacharea_BFSFR/res/Weibull_frequencyderivations_data.csv")

# Get the absolute values and then multiply by -1
frequency_data <- abs(frequency_data) * -1

# Select the desired columns
selected_data <- frequency_data[, c("folder_Weibull.0.001.", "folder_Weibull.0.0015.", "folder_Weibull.0.002.", "folder_Weibull.0.0025.", "folder_Weibull.0.003.", "folder_Weibull.0.0035.", "folder_Weibull.0.004.")]
...
numeric_parts <- as.numeric(gsub("folder_Weibull\\.(.*)\\.", "\\1", original_labels))
# Multiply by 10
...
new_labels <- paste0(aligned_numeric_parts, " * weibull(a,b)")
