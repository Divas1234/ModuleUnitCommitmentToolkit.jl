...
function draw_SFR_additionalpower(
    ...
    p1 = Plots.plot(
        collect(0:0.05:60),
        sum_ConventionalUnitsPower_bench[1:1201, 1] .+ (sum_WindPower_bench[1:1201, 1] .* 0.50 .+ sum_Bess_bench[1:1201, 1]) .* 1.00;
        label = "TUC",
        la = 0.95,
        lc = colorant"#000000",
        lw = 3.0,
    ...
    p1 = Plots.plot!(
        collect(0:0.05:60),
        sum_ConventionalUnitsPower_enhanced[1:1201, 1] .+ sum_WindPower_enhanced[1:1201, 1] .+ sum_Bess_enhanced[1:1201, 1];
        label = "r-FCUC",
        la = 0.95,
        lc = colorant"#a00000",
        lw = 3.0,
