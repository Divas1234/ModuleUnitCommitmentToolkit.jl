...
function add_data_center_power_constraints!(
    ...
    @constraint(
        model,
        [s = 1:scenario_count, t = 1:time_count, dc = 1:data_center_count],
...
function add_convex_grid_reconstruction_constraints!(
    ...
    add_grid_pair!(
        variables.fv2_plus,
        variables.fv2_square_plus,
        response_grid.fv2_plus_grid,
        response_grid.fv2_2_plus_grid,
        variables.weight_fv2_plus,
    )
    add_grid_pair!(
        variables.fv2_minus,
        variables.fv2_square_minus,
        response_grid.fv2_minus_grid,
        response_grid.fv2_2_minus_grid,
        variables.weight_fv2_minus,
    )
    add_grid_pair!(
        variables.fv2lambda_plus,
        variables.fv2lambda_square_plus,
        response_grid.fv2lambda_plus_grid,
        response_grid.fv2lambda_2_plus_grid,
        variables.weight_fv2lambda_plus,
    )
    add_grid_pair!(
        variables.fv2lambda_minus,
        variables.fv2lambda_square_minus,
        response_grid.fv2lambda_minus_grid,
        response_grid.fv2lambda_2_minus_grid,
        variables.weight_fv2lambda_minus,
    )
    return nothing
end
