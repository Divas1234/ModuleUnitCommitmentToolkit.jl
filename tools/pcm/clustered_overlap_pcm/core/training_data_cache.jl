...
function build_case_metadata(; input_file::AbstractString, load_profile::AbstractString, solver::AbstractString,
        ...
        formulation::AbstractString = "single", sampling_version::AbstractString = "hourly-v1")
    metadata = Dict{String, String}(
        ...
        "formulation" => lowercase(strip(formulation)),
        "sampling_version" => lowercase(strip(sampling_version)),
