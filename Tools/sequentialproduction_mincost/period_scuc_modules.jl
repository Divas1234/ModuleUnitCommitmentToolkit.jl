...
function update_boundary_conditions(interval_scheduling_id, NG::Int64, NT::Int64, units::unit, loads::load, winds::wind, results::Dict{String, Array{Float64}})
...
function each_period_scucmodel_modules(NT::Int64, NB::Int64, NG::Int64, ND::Int64, NC::Int64, ND2::Int64, units::unit, loads::load, winds::wind, lines::transmissionline,
        DataCentras::data_centra, config_param::config, stroges::Any, scenarios_prob::Float64, NL::Int64, interval_scheduling_id::Int64, hydros::hydro, NH::Int64)
    ...
    try
        ...
        results = solve_and_extract_results(scuc, NT, NG, ND, NC, NW, NS, ND2, NH, scenarios_prob, eachslope, refcost, config_param, interval_scheduling_id)
        # --- Return Results ---
