...
function draw_SFR_additionalpower(
    ...
    p1 = Plots.plot(
        collect(0:0.05:30),
        sum_ConventionalUnitsPower_proposed[1:601, 1] .+ sum_WindPower_proposed[1:601, 1] .+
        sum_Bess_proposed[1:601, 1];
        xlims = (0, 30),
        ylims = (0, 0.35),
        size = (300, 300),
        xlabel = L"t / s",
    ...
    p1 = Plots.plot!(
        collect(0:0.05:60),
        sum_ConventionalUnitsPower_enhanced[1:1201, 1] .+ sum_WindPower_enhanced[1:1201, 1] .+
        sum_Bess_enhanced[1:1201, 1];
        label = "CCFDUC",
        la = 0.5,
        lc = :blue,
        lw = 3.0,
