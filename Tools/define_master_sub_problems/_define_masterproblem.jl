...
function bd_masterfunction(
	...
	scuc_masterproblem, x, u, v, su₀, sd₀,
	θ = define_masterproblem_decision_variables!(
	...
	scuc_masterproblem,
	obj = set_masterproblem_objective_economic!(
	...
	scuc_masterproblem, _units_minuptime_constr, _units_mindowntime_constr, _units_init_stateslogic_consist_constr,
	_units_states_consist_constr, _units_init_shutup_cost_constr, _units_init_shutdown_cost_constr,
