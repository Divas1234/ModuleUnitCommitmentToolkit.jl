@testset "Wasserstein DRO utilities" begin
	...
	value_at_zero, probability_at_zero =
		worst_case_expected_value(costs, dro_model.nominal_probability, 0.0, distance_matrix)
	value_at_radius, probability_at_radius =
		worst_case_expected_value(costs, dro_model.nominal_probability, 0.05, distance_matrix)
