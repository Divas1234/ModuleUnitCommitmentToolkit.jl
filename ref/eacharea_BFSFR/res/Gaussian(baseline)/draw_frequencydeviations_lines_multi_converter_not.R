...
# Read both CSV files
data1 <- read.csv("sampledata1.csv")
data2 <- read.csv("sampledata2.csv")
...
ggsave("frequency_derivations_converter_not_both_noise.pdf", plot = p, width = 3.5, height = 4, dpi = 300)
cat("Plot saved to frequency_derivations_converter_not_both_noise.pdf\n")

# Save the plot_data to a CSV file
write.csv(plot_data_combined, "plot_data_statistics_converter_not_both_noise.csv", row.names = FALSE)
cat("Plot data saved to plot_data_statistics_converter_not_both_noise.csv\n")
