...
function bd_masterfunction(
	...
	scuc_masterproblem, _units_minuptime_constr, _units_mindowntime_constr, _units_init_stateslogic_consist_constr, _units_states_consist_constr, _units_init_shutup_cost_constr,
	_units_init_shutdown_cost_constr, _units_shutup_cost_constr, _units_shutdown_cost_constr = add_unit_operation_constraints!(scuc_masterproblem, NT, NG, units, onoffinit)
