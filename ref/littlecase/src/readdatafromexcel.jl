...
function readxlssheet()
    ...
    if Sys.iswindows()
        df = XLSX.readxlsx("D:\\GithubClonefiles\\RFCUC\\RfcucCaseStudies\\littlecase\\data/data.xlsx")
    elseif Sys.isapple()
        df = XLSX.readxlsx("/Users/yuanyiping/Documents/GitHub/RFCUC/RfcucCaseStudies/littlecase/data/data.xlsx")
    end
