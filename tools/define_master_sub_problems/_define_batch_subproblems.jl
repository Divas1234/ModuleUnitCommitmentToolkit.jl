...
"""
function get_batch_scuc_subproblems_for_scenario(scuc_subproblem::Model, sub_model_struct::SCUC_Model, winds::wind, config_param::config, NS::Int64)
...
function modify_winds_constr_rhs!(scuc_subproblem, winds, scenarios_curve)
    ...
    set_normalized_rhs.([modified_constr[1, t][w] for t in 1:NT, w in 1:NW], scenarios_curve .* winds.p_max[:, 1]')
