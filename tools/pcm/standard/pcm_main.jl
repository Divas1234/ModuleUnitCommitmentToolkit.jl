...
const PCM_RANDOM_SEED = parse(Int, get(ENV, "PCM_RANDOM_SEED", "20260809"))
...
println("  Clustered UC layer: $(lowercase(get(ENV, "PCM_USE_CLUSTERED_UC", "true")) in ("1","true","yes","on") ? "enabled" : "disabled")")
...
for interval_scheduling_id ∈ 1:patch_scheduling_ids_numssets
    ...
    poster_scheduling_results = each_period_scucmodel_modules(mini_NT, NB, NG, ND, NC, ND2, mini_units, mini_loads, mini_winds, lines, DataCentras,
