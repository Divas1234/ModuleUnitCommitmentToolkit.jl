...
function set_objective_economic!(
    ...
    @objective(
        scuc,
        Min,
        sum(sum(su₀[i, t] + sd₀[i, t] for i in 1:NG) for t in 1:NT)+pₛ *
                                                                    c₀ *
                                                                    (
                                                                        sum(
                                                                            sum(
