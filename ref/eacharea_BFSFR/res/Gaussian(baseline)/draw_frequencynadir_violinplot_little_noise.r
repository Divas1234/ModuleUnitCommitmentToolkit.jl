...
ggsave("D:/GithubClonefiles/RFCUC/RfcucCaseStudies/eacharea_BFSFR/res/Gaussian(baseline)/frequencynadir_violin_little_noise.pdf", plot = p, width = 3.5, height = 4, units = "in", dpi = 300)
