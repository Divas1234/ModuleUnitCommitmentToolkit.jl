...
function forminputdata(DataGen, DataBranch, DataLoad, LoadCurve, GenCost, UnitsFreqParam, StrogeData, datacentra_Data, HydroData, HydroCurve)
    ...
    units = unit(Gens_Index, Gens_LocateBus, Gens_Pmax, Gens_Pmin, Gens_RU, Gens_RD, Gens_SU, Gens_SD, Gens_TU, Gens_TD, Gens_x0,
        Gens_t0, Gens_t1, Gens_p0, Gens_a, Gens_b, Gens_c, Gens_CU, Gens_CU1, Gens_CD, Gens_Cold, Hg, Dg, Kg, Fg, Tg, Rg)
    ...
    hydros = hydro(hydros_index, hydros_locatebus, hydros_pmax, hydros_pmin, hydros_qmax, hydros_q0, hydros_reservoir_curve)
